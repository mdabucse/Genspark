    ...
    public partial class First : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 101, new DateTime(2026, 5, 13, 14, 33, 14, 489, DateTimeKind.Local).AddTicks(2180), "ramu@gmail.com", "Ramu", "9876543210", "Active" });

            migrationBuilder.InsertData(
                table: "accounts",
                columns: new[] { "AccountNumber", "Balance", "CustomerId", "LastAccessed", "Status" },
                values: new object[] { "0009998877", 134.3m, 101, new DateTime(2026, 5, 13, 14, 33, 14, 489, DateTimeKind.Local).AddTicks(3670), "Active" });

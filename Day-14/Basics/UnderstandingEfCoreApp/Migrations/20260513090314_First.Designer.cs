...
namespace UnderstandingEfCoreApp.Migrations
{
    ...
    [Migration("20260513090314_First")]
    partial class First
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UnderstandingEfCoreApp.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Balance = 134.3m,
                            CustomerId = 101,
                            LastAccessed = new DateTime(2026, 5, 13, 14, 33, 14, 489, DateTimeKind.Local).AddTicks(3670),
                            Status = "Active"
                        });
                });
            ...
            modelBuilder.Entity("UnderstandingEfCoreApp.Models.Customer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 101,
                            DateOfBirth = new DateTime(2026, 5, 13, 14, 33, 14, 489, DateTimeKind.Local).AddTicks(2180),

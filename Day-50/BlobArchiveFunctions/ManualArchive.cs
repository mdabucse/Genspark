...
public class ManualArchive
{
    ...
    public ManualArchive(
        BlobArchiveService archiveService,
        ILogger<ManualArchive> logger)
    {
        ...
        [HttpTrigger(AuthorizationLevel.Anonymous, "post")] HttpRequestData req)
    {
        ...
        _logger.LogInformation(
            "ManualArchive triggered — archiving files older than {Days} day(s).",
            days);

        int count = await _archiveService.ArchiveOldBlobsAsync(days);

...
public partial class GensparkContext : DbContext
{
    public GensparkContext()
    {
    }

    public GensparkContext(DbContextOptions<GensparkContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<Forcsharp> Forcsharps { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Database=genspark;Username=mohamedabubakkars;Password=root");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Forcsharp>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("forcsharp");
